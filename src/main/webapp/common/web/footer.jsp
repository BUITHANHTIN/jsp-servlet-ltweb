...
<div class="footer_agileinfo_w3">
	<div class="footer_inner_info_w3ls_agileits">
		<div class="col-md-3 footer-left">
			<h2>
				<a href="index.html"><span>D</span>owny Shoes </a>
			</h2>
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="contact.html">Shop Now</a></li>
					</ul>
				</div>
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						<li><a href="single.html"><img
								src='<c:url value="/template/web/images/t1.jpg" />' alt=" "
								class="img-responsive" /></a></li>
						<li><a href="single.html"><img
								src='<c:url value="/template/web/images/t2.jpg" />' alt=" "
								class="img-responsive" /></a></li>
						<li><a href="single.html"><img
								src='<c:url value="/template/web/images/t3.jpg" />' alt=" "
								class="img-responsive" /></a></li>
						<li><a href="single.html"><img
								src='<c:url value="/template/web/images/t4.jpg" />' alt=" "
								class="img-responsive" /></a></li>
						<li><a href="single.html"><img
								src='<c:url value="/template/web/images/t1.jpg" />' alt=" "
								class="img-responsive" /></a></li>
		...
		<p class="copy-right-w3ls-agileits">
			&copy 2018 Downy Shoes. All rights reserved | Design by <a
